describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokena').should('contain.text', 'QUICK')
  ...
  it('loads the BNB and tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb').should('contain.text', 'QUICK')
  })
  ...
  it('does not crash if address is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena').should('contain.text', 'QUICK')
    cy.get('#add-liquidity-input-tokenb').should('not.contain.text', 'QUICK')
  })

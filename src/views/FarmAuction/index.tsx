...
import { Button, Heading, Text, Flex, Link, Breadcrumbs } from '@lenoswap/uikit'
        ...
        <Flex flexDirection={['column-reverse', null, 'row']}>
          <Left>
            ...
            <Text color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid LENO for the right to host a 7-day Farm on PancakeSwap.')}
            </Text>

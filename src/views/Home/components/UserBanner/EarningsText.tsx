...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and QUICK pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and QUICK pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from QUICK pool', data)
  }

...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and LENO pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and LENO pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from LENO pool', data)
  }

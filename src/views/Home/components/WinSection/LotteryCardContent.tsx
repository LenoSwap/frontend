...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@quickswap-core/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in QUICK prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with QUICK, win QUICK if your numbers match')}
        </Text>
      </Flex>

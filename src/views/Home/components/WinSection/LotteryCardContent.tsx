...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@lenoswap/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in LENO prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with LENO, win LENO if your numbers match')}
        </Text>
      </Flex>

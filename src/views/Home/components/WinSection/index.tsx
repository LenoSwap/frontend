...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@lenoswap/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'LENO card' },
    { src: 'green', alt: 'Green LENO card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'LENO card' },
  ],
}

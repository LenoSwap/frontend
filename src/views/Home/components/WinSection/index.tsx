...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@quickswap-core/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'QUICK card' },
    { src: 'green', alt: 'Green QUICK card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'QUICK card' },
  ],
}

...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from '@lenoswap/uikit'
    ...
    switch (step) {
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get LENO-BNB LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake LENO and BNB in the liquidity pool to get LP tokens.')} <br />
              {t('You’ll spend them to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
              href={`${BASE_ADD_LIQUIDITY_URL}/BNB/0xE73d20C21866B926a7dd240F8e0737d32fd3A19f`}
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent LENO-BNB LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )

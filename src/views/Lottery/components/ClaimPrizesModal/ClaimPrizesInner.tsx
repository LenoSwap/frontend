...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@quickswap-core/uikit'
      ...
      if (receipt.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your QUICK prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}

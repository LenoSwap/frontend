...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@lenoswap/uikit'
      ...
      if (receipt.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your LENO prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}

...
import { Flex, Grid, Box, Text, Button, BinanceIcon, ErrorIcon, useTooltip } from '@quickswap-core/uikit'
...
const SetPriceStage: React.FC<SetPriceStageProps> = ({
  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    <>
      ...
      <Text>{t('%percentage%% trading fee will be used to buy & burn QUICK', { percentage: tradingFee })}</Text>
    </>,
    { placement: 'auto' },
  )

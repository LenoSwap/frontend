...
import { Flex, Grid, Box, Text, Button, BinanceIcon, ErrorIcon, useTooltip } from '@lenoswap/uikit'
...
const SetPriceStage: React.FC<SetPriceStageProps> = ({
  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    <>
      ...
      <Text>{t('%percentage%% trading fee will be used to buy & burn LENO', { percentage: tradingFee })}</Text>
    </>,
    { placement: 'auto' },
  )

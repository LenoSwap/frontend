...
import { Button } from '@lenoswap/uikit'
...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold LENO'),
      bodyText: [t('Each NFT costs LENO to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://pancakeswap.finance/swap?outputCurrency=0x22241835329ffac90DDB9C5fCECbbc711fDf777C"
            target="_blank"
            width="100%"
          >
            {t('Buy LENO')}

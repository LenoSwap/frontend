...
import { Heading, Flex, Text } from '@lenoswap/uikit'
// import { Heading, Flex, Image, Text } from '@lenoswap/uikit'
  ...
  const cardLayout = (
    <CardLayout>
      {chosenPools.map((pool) =>
        pool.isAutoVault ? (
          <CakeVaultCard key="auto-leno" pool={pool} showStakedOnly={stakedOnly} />
        ) : (

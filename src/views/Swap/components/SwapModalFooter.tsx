...
import { Trade, TradeType } from '@lenoswap/sdk'
import { Button, Text, AutoRenewIcon } from '@lenoswap/uikit'
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards LENO buyback and burn', { amount: '0.05%' })}</Text>
                </>
              }
              ml="4px"
            />
